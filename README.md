...
На примере стоек регистрации в аэропорту смоделировать работу простейшей системы балансировки нагрузки, функционирующей по принципу «Least Connections». Стойки регистрации для обслуживания новых пассажиров должны выбираться таким образом, чтобы прибывающие пассажиры направлялись в самую короткую очередь.
